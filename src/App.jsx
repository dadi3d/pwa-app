...
import Verfügbarkeiten from './pages/equipment-manager/Verfügbarkeiten.jsx';
...
function MobileMenu({ userRole }) {
  ...
  // Kein Menü auf Login-Seiten und Logout-Seite anzeigen
  const loginPaths = ['/', '/login', '/admin', '/logout'];
        ...
        <Routes>
          ...
          {(userRole === 'admin' || userRole === 'employee') && (
            <>
              ...
              <Route path="/verfügbarkeiten" element={<Verfügbarkeiten />} />
            </>
          )}
        </Routes>
      </div>
